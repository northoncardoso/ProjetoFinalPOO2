		...
		for (int i = 0; i < 16; i++) {
			...
			bbotoes[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					// id = numero da posicao da imagem
					...
					if (posAbertas < 0) {
						...
						posAbertas = -1;
						if ((pontuacao == 160) || (counter <= 0)) {
							
							setVisible(false);
							System.out.println(bbb + pontuacao);
							
							// nao esta salvando
							connect.insertPontuacao(bbb, pontuacao);
